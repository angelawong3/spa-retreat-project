...
db.once("open", async () => {
  ...
  const treatments = await Treatments.insertMany([
    ...
    },
    {
      name: "Facial massage",
      description:
        "Combining our most-loved Elemis treatments to create the ultimate two-hour experience. Your treatment will begin with a relaxing full body massage.",
      price: 160,
      pictureURL:
    ...
    },
    {
      ...
      description:
        "Total relaxation. This massage focuses on energy centres of the head, neck, scalp, and face by using key acupressure points to relieve tension and stress.",
      price: 80,
      pictureURL:
    ...
    },
    {
      ...
      description:
        "A luxurious hand and nail treatment. Using the latest anti-ageing products.",
      price: 55,
      pictureURL:
    ...
    },
    {
      ...
      description:
        "Hot to trot. Focusing on the foot and lower leg, this treatment includes a warm foot bath.",
      price: 55,
      pictureURL:
    ...
    {
      name: "Couples body massage ",
      description:
        "Share a memorable occasion with your loved one in a wonderful way.",
      price: 100,
      pictureURL:
